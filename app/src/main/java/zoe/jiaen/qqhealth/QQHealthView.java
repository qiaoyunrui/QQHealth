...
/**
 * Created by Liujilong on 2015/12/15.
...
public class QQHealthView extends View {
    ...
    private void initSize(){
        ...
        mArcRadius = (int) ((308/2)*mMinSize);
        mArcCenterY = (int) (200 * mMinSize);
        mArcRect.left = mArcCenterX - mArcRadius;
        mArcRect.top = mArcCenterY - mArcRadius;
        mArcRect.right = mArcCenterX + mArcRadius;
        mArcRect.bottom = mArcCenterY + mArcRadius;
    ...
    protected void onDraw(Canvas canvas) {
        ...
        for(int i = 0; i < mSteps.length; i++){
            ...
            String date = String.format("%2d日",8+i);
